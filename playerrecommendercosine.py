...
with data_info1:
    st.markdown(
        'Based on the 2022/23 season data for the **Big 5** European leagues :soccer:')
...
recoms = getRecommendations(
    sims, df_type=df_type, league=comp, comparison=comparison, age=age, count=count)
st.table(recoms)

# !npm install localtunnel

# !streamlit run recommender.py & >/content/logs.txt & curl ipv4.icanhazip.com

# -*- coding: utf-8 -*-
"""PlayerRecommenderCosine

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vhw1HzmRrUmDA7JQ8ZtSPihNvatiOqew
"""

# Commented out IPython magic to ensure Python compatibility.
# %%writefile playerrecommender.py
...
@st.cache_data
def getData():
    player_df = pd.read_pickle(r'/content/drive/MyDrive/PlayerRecommender/data_out_df.pickle')
    ...
    gk_df = pd.read_pickle(r'/content/drive/MyDrive/PlayerRecommender/data_gk_df.pickle')
...
with col2:
  ...
  age_default = (15,41)
  query = st.selectbox('Player name', players, help ='Ketik tanpa menghapus kata, untuk mencari pemain dari klub tertentu, ketikkan nama klub tersebut')
